...
class DepartureLocationSelectionPage extends StatefulWidget {
  const DepartureLocationSelectionPage({super.key});

  @override
  State<DepartureLocationSelectionPage> createState() => _DepartureLocationSelectionPageState();
}

class _DepartureLocationSelectionPageState extends State<DepartureLocationSelectionPage> {
